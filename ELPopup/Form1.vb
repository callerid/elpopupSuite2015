...
#Region "Properties"
    ...
    Private WithEvents UdpReceiver2 As New UdpReceiverClass2
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Text = "ELPopup - " + Application.ProductVersion.ToString
    ...
    Private Sub DataReceivedEventHandler(sender As Object) Handles UdpReceiver.DataReceived, UdpReceiver2.DataReceived
...
#End Region
    ...
    Private Sub timerKeyWatch_Tick(sender As System.Object, e As System.EventArgs) Handles timerKeyWatch.Tick

        If GetAsyncKeyState(Keys.F12) Then

            ' Display/hide form
            If OnHooks.Visible = False Then
                OnHooks.Show()
            Else
                OnHooks.Hide()
            End If
        ...
        ' Check lines
        If txtLine1.BackColor = Color.Beige Or txtLine1.BackColor = Color.PaleTurquoise Then
            OnHooks.lbL1.Text = "L1: Call"
            OnHooks.lbL1.ForeColor = Color.Red
        ElseIf txtLine1.BackColor = Color.MistyRose Then
            OnHooks.lbL1.Text = "L1: Ring"
            OnHooks.lbL1.ForeColor = Color.Red
        Else
            OnHooks.lbL1.Text = "L1: Idle"
            OnHooks.lbL1.ForeColor = Color.Black
        End If

        If txtLine2.BackColor = Color.Beige Or txtLine2.BackColor = Color.PaleTurquoise Then
            OnHooks.lbL2.Text = "L2: Call"
            OnHooks.lbL2.ForeColor = Color.Red
        ElseIf txtLine2.BackColor = Color.MistyRose Then
            OnHooks.lbL2.Text = "L2: Ring"
            OnHooks.lbL2.ForeColor = Color.Red
        Else
            OnHooks.lbL2.Text = "L2: Idle"
            OnHooks.lbL2.ForeColor = Color.Black
        End If

        If txtLine3.BackColor = Color.Beige Or txtLine3.BackColor = Color.PaleTurquoise Then
            OnHooks.lbL3.Text = "L3: Call"
            OnHooks.lbL3.ForeColor = Color.Red
        ElseIf txtLine3.BackColor = Color.MistyRose Then
            OnHooks.lbL3.Text = "L3: Ring"
            OnHooks.lbL3.ForeColor = Color.Red
        Else
            OnHooks.lbL3.Text = "L3: Idle"
            OnHooks.lbL3.ForeColor = Color.Black
        End If

        If txtLine4.BackColor = Color.Beige Or txtLine4.BackColor = Color.PaleTurquoise Then
            OnHooks.lbL4.Text = "L4: Call"
            OnHooks.lbL4.ForeColor = Color.Red
        ElseIf txtLine4.BackColor = Color.MistyRose Then
            OnHooks.lbL4.Text = "L4: Ring"
            OnHooks.lbL4.ForeColor = Color.Red
        Else
            OnHooks.lbL4.Text = "L4: Idle"
            OnHooks.lbL4.ForeColor = Color.Black
        End If
